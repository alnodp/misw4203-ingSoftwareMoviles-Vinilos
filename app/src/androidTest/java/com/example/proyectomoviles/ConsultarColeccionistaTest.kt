...
class ConsultarColeccionistaTest {
    ...
    @Test
    fun consultarColeccionistaHUTest() {
        ...
        val textView = Espresso.onView(
            Matchers.allOf(
                ViewMatchers.withId(R.id.tvCollectortName), ViewMatchers.withText("Manolo Bellon"),
                ViewMatchers.withParent(ViewMatchers.withParent(IsInstanceOf.instanceOf(LinearLayout::class.java))),
                ViewMatchers.isDisplayed()
            )
        )
        textView.check(ViewAssertions.matches(ViewMatchers.withText("Manolo Bellon")))
        ...
        val titleView = Espresso.onView(
            Matchers.allOf(
                ViewMatchers.withId(R.id.coldName), ViewMatchers.withText("Manolo Bellon"),
                ViewMatchers.withParent(ViewMatchers.withParent(IsInstanceOf.instanceOf(LinearLayout::class.java))),
                ViewMatchers.isDisplayed()
            )
        )

        titleView.check(ViewAssertions.matches(ViewMatchers.withText("Manolo Bellon")))
